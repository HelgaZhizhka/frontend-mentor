...
- [**3. Единообразие единиц измерения**](CSS.md#3-единообразие-единиц-измерения)
  ...
  - [3.2 Проблема смешивания единиц](CSS.md#32-проблема-смешивания-единиц)
  - [3.3 Unitless line-height](CSS.md#33-unitless-line-height)
- [**4. Организация CSS файлов**](CSS.md#4-организация-css-файлов)
- [**5. CSS переменные (Custom Properties)**](CSS.md#5-css-переменные-custom-properties)
- [**6. Responsive дизайн**](CSS.md#5-responsive-дизайн)
- [**7. Производительность**](CSS.md#6-производительность)
