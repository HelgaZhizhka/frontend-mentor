...
# 1. Принципы чистого кода в архитектурных паттернах
...
***
### 1.5 Separation of Concerns (Разделение ответственности)
...
```
***
### 1.6 Composition over Inheritance (Композиция вместо наследования)
