...
Этот репозиторий — подборка лучших практик кода, задач, теории и типовых вопросов на собеседованиях для студентов на курсах Front-End и React RS School. Все бережно и с заботой собранно мной, из собственного опыта обучения и менторства.  
