...
Этот репозиторий — подборка лучших практик кода, задач, теории и типовых вопросов на собеседованиях для студентов на курсах Front-End и React RS School. Все собранно бережно и с заботой на основе собственного опыта обучения и менторства.  
...
- 🎯 Студенты курсов Front-End и React RS School. 
    
- 👩‍💻 Менторы RS School. 
    
- 👫 Все, кто проходит собеседование как front-end developer. 
...
- Students courses Front-End and React in RS School. 
    
- Mentors and educators. 
    
- Anyone preparing for interviews or improving their frontend skills. 

## 🤝 Contributing

Suggestions, questions, and new challenges are welcome!  
